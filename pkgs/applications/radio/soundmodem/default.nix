...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://archive.org/download/soundmodem-${finalAttrs.version}/soundmodem-${finalAttrs.version}.tar.gz";
  ...
  meta = with lib; {
    ...
    downloadPage = "https://archive.org/download/${pname}-${finalAttrs.version}/${pname}-${finalAttrs.version}.tar.gz";
