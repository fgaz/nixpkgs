...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "mirror://sourceforge/mp3val/${finalAttrs.pname}-${finalAttrs.version}-src.tar.gz";
  ...
  meta = {
    ...
    longDescription = ''
      ...
      also other MPEG finalAttrs.versions and layers. The tool is also aware of the most
