...
stdenv.mkDerivation (finalAttrs: {
  ...
  version = "2.2";
  src = fetchurl {
    url = "mirror://sourceforge/project/eq10q/${finalAttrs.pname}-${finalAttrs.version}.tar.gz";
  ...
  meta = {
    ...
    longDescription = ''
      Up to 10-Bands parametric equalizer with mono and stereo finalAttrs.versions.
      Versatile noise-gate plugin with mono and stereo finalAttrs.versions.
      Compressor plugin with mono and stereo finalAttrs.versions.
