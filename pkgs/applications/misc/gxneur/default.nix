...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://github.com/AndrewCrewKuznetsov/xneur-devel/raw/f66723feb272c68f7c22a8bf0dbcafa5e3a8a5ee/dists/${finalAttrs.version}/gxneur_${finalAttrs.version}.orig.tar.gz";
