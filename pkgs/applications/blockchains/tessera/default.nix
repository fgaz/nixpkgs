...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://oss.sonatype.org/service/local/repositories/releases/content/com/jpmorgan/quorum/${finalAttrs.pname}-app/${finalAttrs.version}/${finalAttrs.pname}-app-${finalAttrs.version}-app.jar";
